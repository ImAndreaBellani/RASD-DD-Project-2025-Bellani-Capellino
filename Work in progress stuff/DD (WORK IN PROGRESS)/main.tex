...
\titlehead{Design Document}

\title[Design Document]{Design Document}
...
\publishers{\includegraphics[width=6cm]{Politecnico.png}}

\hypersetup{
	pdftitle={Design Document},
	pdfauthor={Andrea Bellani, Alessandro Capellino},
	pdfsubject={Computer Science and Engineering},
	pdfkeywords={Software Engineering, Computer Science, Engineering, Application Design, Software\&Companies, Politecnico di Milano},
	pdfcreator={LaTeX},
}
