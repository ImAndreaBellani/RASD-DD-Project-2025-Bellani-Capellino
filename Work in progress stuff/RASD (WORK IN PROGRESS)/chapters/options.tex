...
\labch{options}
	\section{Product perspective}
		\subsection{Scenarios}
			...
			\begin{flushleft}
				The company FinestraMI enters in the system; on the homepage, it clicks the \emph{Login button}. Once logged in, FinestraMI accesses the \emph{Publish New Advice section}. A new internship advice is added by filling out a form where the following information is provided:
				\begin{itemize}
		...
		\subsection{High-level class diagram}
			...
			\subsection{State Diagrams}
				...
				\subparagraph{State of an application for an internship}
					\begin{figure}[H]
						\centering
						\includegraphics{application.jpg}
