		...
		\subsection{Requirements mapping}
			\begin{table} [h!]
				...
				\begin{tabular}{ || P{5cm} P{5cm} || }
					\hline
						\multicolumn{2}{||P{10cm}||}{[G1] students and companies establish contacts for doing internships} \\ [0.5ex]
					\hline
			...
			\begin{table} [h!]
				...
				\begin{tabular}{ || P{5cm} P{5cm} || }
					\hline
					\multicolumn{2}{||P{10cm}||}{[G2] internships selections can be monitored and supported by the system} \\ [0.5ex]
					\hline
			...
			\begin{table} [h!]
				...
				\begin{tabular}{ || P{5cm} P{5cm} || }
					\hline
					\multicolumn{2}{||P{10cm}||}{[G3] ongoing internships can be monitored from the system} \\ [0.5ex]
					\hline
