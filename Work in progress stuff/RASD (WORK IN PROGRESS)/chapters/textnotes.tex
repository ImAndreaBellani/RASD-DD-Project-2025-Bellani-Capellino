			...
			\begin{table} [H]
				...
				\begin{table} [H]
					...
					\begin{tabular}{|| P{7.5cm} | P{7.5cm} ||}
						...
						\hline
						Event Flow & \parbox{5cm}{\begin{enumerate}[label=\alpha]
								\item The company gives to the sudent the questionnaire with closed and open questions
								...
								\item the sytstem shows a form to fill with the answers
				...
				\begin{table} [H]
					\centering
					\begin{itemize}
						\item [UC14] - Collection of Student Selection Process Feedbacks
					\end{itemize}
				...
				\begin{table} [H]
					\centering
					\begin{itemize}
						\item [UC15] - Collection of Company Selection Process Feedbacks
					\end{itemize}
				...
				\end{table}
					...
					\centering
					\begin{itemize}
						\item [UC16] - Collection of Internship Feedbacks
					\end{itemize}
				...
				\end{table}
					...
					\centering
					\begin{itemize}
						\item [UC18] - Company Cancellation
					\end{itemize}
				...
				\begin{table} [H]
					\centering
					\begin{itemize}
						\item [UC19] - Student Cancellation
					\end{itemize}
